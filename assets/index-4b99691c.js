...
function ph(a2, b, c) {
  ...
  "object" === typeof f2 && null !== f2 ? f2 = Vg(f2) : (e2 = Zf(b) ? Xf : H.current, d = b.contextTypes, f2 = (d = null !== d && void 0 !== d) ? Yf(a2, e2) : Vf);
  b = new b(c, f2);
...
function rh(a2, b, c, d) {
  ...
  ah(a2);
  var f2 = b.contextType;
  "object" === typeof f2 && null !== f2 ? e2.context = Vg(f2) : (f2 = Zf(b) ? Xf : H.current, e2.context = Yf(a2, f2));
  e2.state = a2.memoizedState;
...
function vh(a2) {
  ...
  function J2(a3, d2, f3, h2) {
    ...
    return "string" === typeof f3 && "" !== f3 || "number" === typeof f3 ? (f3 = "" + f3, null !== d2 && 6 === d2.tag ? (c(a3, d2.sibling), d2 = e2(d2, f3), d2.return = a3, a3 = d2) : (c(a3, d2), d2 = xh(f3, a3.mode, h2), d2.return = a3, a3 = d2), g(a3)) : c(a3, d2);
  }
  return J2;
}
...
function ri(a2, b, c) {
  ...
  if (Hi(a2))
    ...
    c = Yg(a2, b, e2, d);
    null !== c && (e2 = L$1(), mh(c, a2, d, e2), Ji(c, b, d));
  }
}
function Hi(a2) {
  var b = a2.alternate;
...
function ej(a2, b, c) {
  ...
  if ("hidden" === d.mode)
    if (0 === (b.mode & 1))
      ...
      if (0 === (c & 1073741824))
        return a2 = null !== f2 ? f2.baseLanes | c : c, b.lanes = b.childLanes = 1073741824, b.memoizedState = { baseLanes: a2, cachePool: null, transitions: null }, b.updateQueue = null, G(fj, gj), gj |= a2, null;
  ...
  switch (b.tag) {
    ...
    case 13:
      ...
      if (0 !== (b.flags & 128))
        return b.lanes = c, b;
      d = null !== d;
      d !== (null !== a2 && null !== a2.memoizedState) && d && (b.child.flags |= 8192, 0 !== (b.mode & 1) && (null === a2 || 0 !== (M.current & 1) ? 0 === T$1 && (T$1 = 3) : uj()));
    ...
    case 19:
      ...
      if (null === g)
        ...
        if (!d)
          if (a2 = Mh(g), null !== a2) {
            if (b.flags |= 128, d = true, c = a2.updateQueue, null !== c && (b.updateQueue = c, b.flags |= 4), Ej(f2, true), null === f2.tail && "hidden" === f2.tailMode && !g.alternate && !I)
              return S(b), null;
          } else
...
function Jj(a2, b) {
  ...
  switch (b.tag) {
    ...
    case 3:
      return Jh(), E$1(Wf), E$1(H), Oh(), a2 = b.flags, 0 !== (a2 & 65536) && 0 === (a2 & 128) ? (b.flags = a2 & -65537 | 128, b) : null;
    case 5:
      return Lh(b), null;
    case 13:
      E$1(M);
...
var mk = Math.ceil, nk = ua.ReactCurrentDispatcher, ok = ua.ReactCurrentOwner, pk = ua.ReactCurrentBatchConfig, K = 0, R = null, Y = null, Z$1 = 0, gj = 0, fj = Uf(0), T$1 = 0, qk = null, hh = 0, rk = 0, sk = 0, tk = null, uk = null, gk = 0, Hj = Infinity, vk = null, Pi = false, Qi = null, Si = null, wk = false, xk = null, yk = 0, zk = 0, Ak = null, Bk = -1, Ck = 0;
function L$1() {
...
function mh(a2, b, c, d) {
  ...
  Ac(a2, c, d);
  if (0 === (K & 2) || a2 !== R)
    a2 === R && (0 === (K & 2) && (rk |= c), 4 === T$1 && Dk(a2, Z$1)), Ek(a2, d), 1 === c && 0 === K && 0 === (b.mode & 1) && (Hj = B() + 500, fg && jg());
}
function Ek(a2, b) {
...
function Ui(a2, b, c) {
  ...
  R === a2 && (Z$1 & c) === c && (4 === T$1 || 3 === T$1 && (Z$1 & 130023424) === Z$1 && 500 > B() - gk ? Lk(a2, 0) : sk |= c);
  Ek(a2, b);
}
function Zk(a2, b) {
...
function cl(a2, b, c, d, e2, f2, g, h, k2) {
  a2 = new bl(a2, b, c, h, k2);
...
function fl(a2, b, c, d, e2, f2, g, h, k2) {
  a2 = cl(c, d, true, a2, e2, f2, g, h, k2);
  a2.context = el(null);
  c = a2.current;
  d = L$1();
  e2 = lh(c);
...
function gl(a2, b, c, d) {
  var e2 = b.current, f2 = L$1(), g = lh(e2);
  c = el(c);
...
function Header(props) {
  return /* @__PURE__ */ jsxs("header", { children: [
    /* @__PURE__ */ jsx("h2", { children: "CV BUILDER" }),
    /* @__PURE__ */ jsx(
      "button",
      {
...
const samplePhoto = "/cv-app/assets/cv_img-d37a2efd.jpg";
...
var Icon = function(e2) {
  ...
  function r2(n2) {
    ...
    return e2[n2].call(o.exports, o, o.exports, r2), o.l = true, o.exports;
  }
  ...
  var n2 = r2(1), o = r2(0), l2 = function() {
    ...
    if (null != e3 && "function" == typeof Object.getOwnPropertySymbols) {
      ...
      for (n3 = Object.getOwnPropertySymbols(e3); o2 < n3.length; o2++)
        t3.indexOf(n3[o2]) < 0 && Object.prototype.propertyIsEnumerable.call(e3, n3[o2]) && (r3[n3[o2]] = e3[n3[o2]]);
    }
    return r3;
  }, a2 = 0, s = n2.forwardRef(function(e3, t3) {
    var r3 = e3.title, o2 = void 0 === r3 ? null : r3, s2 = e3.description, c2 = void 0 === s2 ? null : s2, u3 = e3.size, p3 = void 0 === u3 ? null : u3, f3 = e3.color, d2 = void 0 === f3 ? "currentColor" : f3, y2 = e3.horizontal, v2 = void 0 === y2 ? null : y2, b = e3.vertical, m2 = void 0 === b ? null : b, h = e3.rotate, g = void 0 === h ? null : h, O2 = e3.spin, w2 = void 0 === O2 ? null : O2, j = e3.style, z2 = void 0 === j ? {} : j, E2 = e3.children, P2 = i(e3, ["title", "description", "size", "color", "horizontal", "vertical", "rotate", "spin", "style", "children"]);
    a2++;
    var S2, x2 = null !== w2 && w2, _ = n2.Children.map(E2, function(e4) {
      var t4 = e4;
  ...
  var u2 = function() {
    ...
    return r3;
  }, f2 = 0, d = n2.forwardRef(function(e3, t3) {
    var r3 = e3.path, o2 = e3.id, l3 = void 0 === o2 ? ++f2 : o2, i2 = e3.title, a3 = void 0 === i2 ? null : i2, s2 = e3.description, c2 = void 0 === s2 ? null : s2, d2 = e3.size, y2 = void 0 === d2 ? null : d2, v2 = e3.color, b = void 0 === v2 ? "currentColor" : v2, m2 = e3.horizontal, h = void 0 !== m2 && m2, g = e3.vertical, O2 = void 0 !== g && g, w2 = e3.rotate, j = void 0 === w2 ? 0 : w2, z2 = e3.spin, E2 = void 0 !== z2 && z2, P2 = e3.style, S2 = void 0 === P2 ? {} : P2, x2 = e3.inStack, _ = void 0 !== x2 && x2, k2 = p2(e3, ["path", "id", "title", "description", "size", "color", "horizontal", "vertical", "rotate", "spin", "style", "inStack"]), T2 = {}, q2 = [];
    ...
    var I2, N2 = C2, R2 = true === E2 || "number" != typeof E2 ? 2 : E2, B3 = !_ && (h || O2);
    if (R2 < 0 && (B3 = !B3), E2 && (N2 = n2.createElement("g", { style: { animation: "spin" + (B3 ? "-inverse" : "") + " linear " + Math.abs(R2) + "s infinite", transformOrigin: "center" } }, C2, !(h || O2 || 0 !== j) && n2.createElement("rect", { width: "24", height: "24", fill: "transparent" }))), _)
      return N2;
    ...
    if (a3)
      ...
      throw new Error("title attribute required when description is set");
    return n2.createElement("svg", u2({ ref: t3, viewBox: "0 0 24 24", style: S2, role: X2, "aria-labelledby": I2 }, k2), a3 && n2.createElement("title", { id: Y2 }, a3), c2 && n2.createElement("desc", { id: A2 }, c2), !_ && E2 && (B3 ? n2.createElement("style", null, "@keyframes spin-inverse { from { transform: rotate(0deg) } to { transform: rotate(-360deg) } }") : n2.createElement("style", null, "@keyframes spin { from { transform: rotate(0deg) } to { transform: rotate(360deg) } }")), N2);
  });
...
function Contacts() {
  ...
  const [name, setName] = reactExports.useState("Name Surname");
  const [email, setEmail] = reactExports.useState("n.surname@mail.com");
  const [phone, setPhone] = reactExports.useState("0123412274");
  const [location2, setLocation] = reactExports.useState("Vilnius, Lithuania");
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "photo-container", children: [
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "file",
              ...
              onChange: (e2) => setPhoto(e2.target.files[0])
            }
          ),
          /* @__PURE__ */ jsx(
            "img",
        ...
        /* @__PURE__ */ jsx("div", { className: "contacts-content", children: editInfo ? /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
          /* @__PURE__ */ jsx(
            "input",
            {
              id: "name",
          ...
          /* @__PURE__ */ jsxs("div", { className: "info-row", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "email", children: email })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "info-row", children: [
            /* @__PURE__ */ jsx(
              Icon.Icon,
            ...
            /* @__PURE__ */ jsx("span", { className: "phone", children: phone })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "info-row", children: [
            /* @__PURE__ */ jsx(
              Icon.Icon,
            ...
            /* @__PURE__ */ jsx("span", { className: "location", children: location2 })
          ] })
        ] }) })
      ]
    }
...
function About() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "about-container", children: [
    ...
    editInfo ? /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsx(
        "textarea",
        {
          name: "about",
      ...
      /* @__PURE__ */ jsx("button", { children: "Save" })
    ] }) : /* @__PURE__ */ jsx("p", { className: "about-description", children: description })
  ] });
}
function ExperienceCard(props) {
  const [id2, setId] = reactExports.useState(props.id);
  const [editInfo, setEditInfo] = reactExports.useState(false);
  const [jobTitle, setJobTitle] = reactExports.useState("JOB TITLE");
  const [companyName, setCompanyName] = reactExports.useState("Company name");
  const [years, setYears] = reactExports.useState("2011-2018");
  ...
  function handleSubmit(e2) {
    e2.preventDefault();
    const formData = document.querySelector(`#${id2} form`);
  ...
  return /* @__PURE__ */ jsx("div", { id: id2, children: !editInfo ? /* @__PURE__ */ jsxs("div", { className: "experience-card", children: [
    /* @__PURE__ */ jsxs("div", { className: "job-title", children: [
      /* @__PURE__ */ jsx("span", { children: jobTitle }),
      " ",
    ...
    /* @__PURE__ */ jsxs("p", { className: "company-name", children: [
      companyName,
      " | ",
      /* @__PURE__ */ jsx("span", { children: years })
    ] }),
    /* @__PURE__ */ jsx("p", { className: "description", children: jobDescription })
  ] }) : /* @__PURE__ */ jsxs("form", { className: "experience-form", onSubmit: handleSubmit, children: [
    /* @__PURE__ */ jsx(
      "input",
      {
        name: "jobTitle",
...
function Experience() {
  const [cardArray, setCardArray] = reactExports.useState([
    {
      id: "e42",
      component: /* @__PURE__ */ jsx(ExperienceCard, { id: "e42", remove: removeFromArray }, "e42")
    },
    {
      id: "e43",
      component: /* @__PURE__ */ jsx(ExperienceCard, { id: "e43", remove: removeFromArray }, "e43")
    }
  ]);
  function addToArray(id2) {
    setCardArray((prev) => [
      ...prev,
      {
        id: id2,
        component: /* @__PURE__ */ jsx(ExperienceCard, { id: id2, remove: removeFromArray }, id2)
      }
    ]);
  }
  function removeFromArray(id2) {
    setCardArray((prev) => prev.filter((item) => item.id !== id2));
  }
  const displayCards = cardArray.map((card) => card.component);
  return /* @__PURE__ */ jsxs("div", { className: "experience-container", children: [
...
function EducationCard(props) {
  const [id2, setId] = reactExports.useState(props.id);
  const [editInfo, setEditInfo] = reactExports.useState(false);
  const [studyField, setStudyField] = reactExports.useState("FIELD OF STUDY");
  const [school, setSchool] = reactExports.useState("Name of Educational Institution");
  const [years, setYears] = reactExports.useState("2009-2013");
  const [studyDescription, setStudyDescription] = reactExports.useState(
    "Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium optio numquam explicabo atque dolore itaque laborum maiores totam minima veritatis."
  );
  function handleSubmit(e2) {
    e2.preventDefault();
  ...
  return /* @__PURE__ */ jsx("div", { id: id2, children: !editInfo ? /* @__PURE__ */ jsxs("div", { className: "education-card", children: [
    /* @__PURE__ */ jsxs("div", { className: "study-field", children: [
      /* @__PURE__ */ jsx("span", { children: studyField }),
      " ",
      /* @__PURE__ */ jsxs("div", { className: "icons", children: [
        /* @__PURE__ */ jsx(
          Icon.Icon,
    ...
    /* @__PURE__ */ jsxs("p", { className: "school", children: [
      school,
      " | ",
      /* @__PURE__ */ jsx("span", { children: years })
    ] }),
    /* @__PURE__ */ jsx("p", { className: "description", children: studyDescription })
  ] }) : /* @__PURE__ */ jsxs("form", { className: "education-form", onSubmit: handleSubmit, children: [
    /* @__PURE__ */ jsx(
      "input",
      {
        name: "studyField",
...
function Education() {
  const [cardArray, setCardArray] = reactExports.useState([
    {
      id: "d42",
      component: /* @__PURE__ */ jsx(EducationCard, { id: "d42", remove: removeFromArray }, "d42")
    },
    {
      id: "d43",
      component: /* @__PURE__ */ jsx(EducationCard, { id: "d43", remove: removeFromArray }, "d43")
    }
  ]);
  function addToArray(id2) {
    setCardArray((prev) => [
      ...
      {
        id: id2,
        component: /* @__PURE__ */ jsx(EducationCard, { id: id2, remove: removeFromArray }, id2)
      }
    ]);
  }
  function removeFromArray(id2) {
  ...
  const displayCards = cardArray.map((card) => card.component);
  return /* @__PURE__ */ jsxs("div", { className: "education-container", children: [
...
function Content() {
  function showButtons() {
    document.querySelectorAll(".content-edit-btn path").forEach((item) => item.style.cssText = "fill: #048500");
    document.querySelectorAll(".content-delete-btn path").forEach((item) => item.style.cssText = "fill: red");
    document.querySelectorAll(".add-new-card path").forEach((item) => item.style.cssText = "fill: #9fcfac");
  }
...
(function(module, exports) {
  (function(root, factory) {
    ...
    return function download2(data, strFileName, strMimeType) {
      var self2 = window, defaultMime = "application/octet-stream", mimeType = strMimeType || defaultMime, payload = data, url = !strFileName && !strMimeType && payload, anchor = document.createElement("a"), toString = function(a2) {
        return String(a2);
...
function App() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "App", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "cv-container", children: [
